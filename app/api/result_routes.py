...
from app.result_management.schemas import UserAssessmentStats
from app.result_management.service import get_user_stats
...
@router.get("/{user_id}/stats", response_model=UserAssessmentStats)
