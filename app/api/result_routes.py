...
@router.get("/employees/{user_id}/assessments", response_model=EmployeeAssessmentsResponse)
...
@router.get("/employees/{user_id}/assessment-attempts", response_model=EmployeeAssessmentAttemptsResponse)
...
@router.get("/courses/{course_id}/assessment-attempts", response_model=CourseAssessmentAttemptsResponse)
